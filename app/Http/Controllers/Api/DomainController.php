...
public function registerCustomer(Request $request)
{
    ...
    $res = $this->omarino->createCustomer($payload);
    ...
    public function searchByPrice(Request $request)
    {
        ...
        $payload = [
            ...
            'tlds' => isset($data['tlds']) ? $data['tlds'] : null,
        ];

        $res = $this->omarino->request('domains/searchByPrice', $payload, 'GET');
    ...
    public function searchByTld(Request $request)
    {
        ...
        $res = $this->omarino->request('domains/searchByTld', $payload, 'GET');
    ...
    public function details(Request $request)
    {
        ...
        $res = $this->omarino->request('domains/details', ['domain-name' => $data['domain']], 'GET');
        return $this->serviceResponse($res);
    }
    ...
    public function cancel(Request $request)
    {
        ...
        if (!empty($orderIdResp['success'])) {
            $orderId = $this->extractOrderId($orderIdResp);
            if ($orderId) {
                $res = $this->omarino->request('domains/delete', ['order-id' => $orderId], 'POST');
                return $this->serviceResponse($res);
            }
        }

        $res = $this->omarino->request('domains/delete', ['domain-name' => $data['domain']], 'POST');
        return $this->serviceResponse($res);
    }

    public function balance()
    {
        return $this->serviceResponse($this->omarino->getBalance());
    }
    ...
    public function lock(Request $request)
    {
        ...
        $res = $this->omarino->toggleTransferLock($orderId, $data['lock']);
        return $this->serviceResponse($res);
    }
    ...
    public function dnsDelete(Request $request)
    {
        ...
        $res = $this->omarino->deleteDnsRecord($payload);
